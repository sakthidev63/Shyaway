...
import com.sakthi.shyaway.feature_wear_list.data.local.entity.toDomain
...
class WearRepositoryImpl @Inject constructor(
    private val wearDao: AppDatabase,
    ...
    override fun getAllWear(
        ...
        return Pager(
            ...
            remoteMediator = ProductRemoteMediator(wearApiService, wearDao, urlKey, sortBy, sortDirection),
            pagingSourceFactory = { wearDao.getWearDAO().getAllWear() }
        ).flow.map { pagingData ->
